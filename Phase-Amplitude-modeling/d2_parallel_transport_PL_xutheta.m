function d2parqi_xutheta = d2_parallel_transport_PL_xutheta(qi, xi, x, theta, uu)
phi = 2*asin(sqrt((1-dot(xi, x))/(1+cos(theta)^2-...
             dot(xi, x)*sin(theta)^2)));  
if (phi <= pi/2)
 d2parqi_xutheta = d2_parallel_transport_PL_xutheta2(qi, xi, x, theta, uu);
else
...
% second derivative of 'phi' and 'normal' 
% with respect to 'x' along the direction 'uu' and 'theta' 
 d2_phi_xutheta = ((cos(theta)*sin(theta)*(2*Xix + 2)*(sin(theta)^2 -...
   2*Xix + Xix*sin(theta)^2))/...
   ((1 - sin(theta)^2)^(1/2)*...
   (1 - Xix)^(1/2)*(Xix + 1)^(3/2)*...
   (sin(theta)^2 + Xix*sin(theta)^2 - 2)^2))*dot(xi, uu);
 d2_normal_xutheta = uu*(cos(theta)/norm(xi + x)) -...% the second term
   (xi +x)*(cos(theta)/norm(xi + x)^3)*dot(xi + x, uu) -...% the third term
   cross(xi, uu)*(sin(theta)/norm(cross(xi, x))) +...% the fourth term
...
% with respect to 'theta'
 x12_theta = -xi*sin(s*phi)*s*dphi_theta +...% the second term
     cross(dnormal_theta, xi)*sin(s*phi) +...
     cross(normal, xi)*cos(s*phi)*s*dphi_theta +...% the third term
     dnormal_theta*dot(normal, xi)*(1 - cos(s*phi)) +...
     normal*dot(dnormal_theta, xi)*(1 - cos(s*phi)) +...
     normal*dot(normal, xi)*sin(s*phi)*s*dphi_theta;
% the derivative of the middle point on the segment (x1, x2) 
% with respect to 'x' along the direction 'uu'
 ...
 % the second derivative of x12 with respect to 'x' and 'theta'
 x12_xutheta = -(xi*cos(s*phi)*s*dphi_theta*s*dphi_xu +...
     xi*sin(s*phi)*s*d2_phi_xutheta) +...% the second term
     (cross(d2_normal_xutheta, xi)*sin(s*phi) +...
     cross(dnormal_xu, xi)*cos(s*phi)*s*dphi_theta) +...% the third term
     (cross(dnormal_theta, xi)*cos(s*phi)*s*dphi_xu -...
     cross(normal, xi)*sin(s*phi)*s*dphi_theta*s*dphi_xu +...
     cross(normal, xi)*cos(s*phi)*s*d2_phi_xutheta) +...% the fourth term
     (d2_normal_xutheta*dot(normal, xi)*(1 - cos(s*phi)) +...
     dnormal_xu*dot(dnormal_theta, xi)*(1 - cos(s*phi)) +...
     dnormal_xu*dot(normal, xi)*sin(s*phi)*s*dphi_theta) +...% the fifth term
     (dnormal_theta*dot(dnormal_xu, xi)*(1 - cos(s*phi)) +...
     normal*dot(d2_normal_xutheta, xi)*(1 - cos(s*phi)) +...
     normal*dot(dnormal_xu, xi)*sin(s*phi)*s*dphi_theta) +...% the final term
     (dnormal_theta*dot(normal, xi)*sin(s*phi)*s*dphi_xu +...
     normal*dot(dnormal_theta, xi)*sin(s*phi)*s*dphi_xu +...
     normal*dot(normal, xi)*cos(s*phi)*s*dphi_theta*s*dphi_xu +...
     normal*dot(normal, xi)*sin(s*phi)*s*d2_phi_xutheta);
 ...
 xx12_theta = (x12_theta)/norm(xi + x12) -...
     (xi + x12)*dot(xi + x12, x12_theta)/(norm(xi + x12)^3);
 % the derivative of 'xx12' with respect to 'x'
 % along the direction 'uu'
 xx12_xu = (x12_xu)/norm(xi + x12) -...
     (xi + x12)*dot(xi + x12, x12_xu)/(norm(xi + x12)^3);
 % the second derivative of 'xx12' with respect to 'x'
 % along the direction 'uu' and 'theta'
 xx12_xutheta = (x12_xutheta)/norm(xi + x12) -...
     (x12_xu)*dot(xi + x12, x12_theta)/(norm(xi + x12)^3) -...% the second term
     (x12_theta)*dot(xi + x12, x12_xu)/(norm(xi + x12)^3) -...
     (xi + x12)*dot(x12_theta, x12_xu)/(norm(xi + x12)^3) -...
     (xi + x12)*dot(xi + x12, x12_xutheta)/(norm(xi + x12)^3) +...
     (xi + x12)*dot(xi + x12, x12_xu)*...
     3*dot(xi + x12, x12_theta)/(norm(xi + x12)^5);
 ...
 % the second derivative of 'theta11' with respect to 'x'
 % along the direction 'uu' and 'theta'
 theta11_xutheta = (dot(xx12_xutheta, normal) +...
     dot(xx12_xu, dnormal_theta) +...
     dot(xx12_theta, dnormal_xu) +...
     dot(xx12, d2_normal_xutheta))/...
     (1 - dot(xx12, normal)^2)^(1/2) +...
     (dot(xx12_xu, normal) + dot(xx12, dnormal_xu))*...
     (dot(xx12_theta, normal) + dot(xx12, dnormal_theta))*...
 ...
 parq11_theta = d_parallel_transport_PL_x222(qi, xi, x12, theta11, x12_theta) +...
     d_parallel_transport_PL_theta2(qi, xi, x12, theta11)*theta11_theta;
 ...
 % the second derivative of 'parq11' with respect to 'x' and 'theta'
 parq11_xutheta = d2_parallel_transport_PL_x2(qi, xi, x12, theta11, x12_xu, x12_theta) +...
     d2_parallel_transport_PL_xutheta2(qi, xi, x12, theta11, x12_xu)*theta11_theta +...
     d_parallel_transport_PL_x222(qi, xi, x12, theta11, x12_xutheta) +...% the second term
     d2_parallel_transport_PL_xutheta2(qi, xi, x12, theta11, x12_theta)*theta11_theta +...
     d2_parallel_transport_PL_theta2(qi, xi, x12, theta11)*theta11_xu*theta11_theta +...
     d_parallel_transport_PL_theta2(qi, xi, x12, theta11)*theta11_xutheta;
 % parallel transport of 'parq11' from 'x12' to 'x' along 
 % the 'beta22' which is the second half of 'beta'
 % defined by angle between 'normal' and 'xx12' 
 xx12 = (x12 + x)/norm(x12 + x);
 % the derivative of 'xx12' with respect to 'theta'
 xx12_theta = (x12_theta)/norm(x12 + x) -...
     (x12 + x)*dot(x12 + x, x12_theta)/(norm(x12 + x)^3);
 % the derivative of 'xx12' with respect to 'x'
 % along the direction 'uu'
 ...
 % the second derivative of 'xx12' with respect to 'x'
 % along the direction 'uu' and 'theta'
 xx12_xutheta = (x12_xutheta)/norm(x12 + x) -...
     (x12_xu)*dot(x12 + x, x12_theta)/(norm(x12 + x)^3) -...% the second term
     (x12_theta)*dot(x12 + x, x12_xu)/(norm(x12 + x)^3) -...
     (x12 + x)*dot(x12_theta, x12_xu)/(norm(x12 + x)^3) -...
     (x12 + x)*dot(x12 + x, x12_xutheta)/(norm(x12 + x)^3) +...
     (x12 + x)*dot(x12 + x, x12_xu)*...
     3*dot(x12 + x, x12_theta)/(norm(x12 + x)^5);
 ...
 theta22_xu = (dot(xx12_xu, normal) +...
     dot(xx12, dnormal_xu))/(1 - dot(xx12, normal)^2)^(1/2);
 % the second derivative of 'theta22' with respect to 'x'
 % along the direction 'uu' and 'theta'
 theta22_xutheta = (dot(xx12_xutheta, normal) +...
     dot(xx12_xu, dnormal_theta) +...
     dot(xx12_theta, dnormal_xu) +...
     dot(xx12, d2_normal_xutheta))/...
     (1 - dot(xx12, normal)^2)^(1/2) +...
 ...
 % along the direction 'uu'
 % dparqi_xu = parallel_transport_PL22(parq11_xu, x12, x, theta22) +...
 ...
 % the second derivative of 'parq1' with respect to 'xu' and 'theta'
 d2parqi_xutheta = parallel_transport_PL2(parq11_xutheta, x12, x, theta22) +...
     d_parallel_transport_PL_x122(parq11_xu, x12, x, theta22, x12_theta) +...
     d_parallel_transport_PL_theta2(parq11_xu, x12, x, theta22)*theta22_theta +...% the second term
     d_parallel_transport_PL_x122(parq11_theta, x12, x, theta22, x12_xu) +...
     d2_parallel_transport_PL_x1(parq11, x12, x, theta22, x12_xu, x12_theta) +...
     d2_parallel_transport_PL_xiutheta2(parq11, x12, x, theta22, x12_xu)*theta22_theta +...
     d_parallel_transport_PL_x122(parq11, x12, x, theta22, x12_xutheta) +...% the third term
     d_parallel_transport_PL_x222(parq11_theta, x12, x, theta22, uu) +...
     d2_parallel_transport_PL_x2x1(parq11, x12, x, theta22, uu, x12_theta) +...
     d2_parallel_transport_PL_xutheta2(parq11, x12, x, theta22, uu)*theta22_theta +...% the final term
     d_parallel_transport_PL_theta2(parq11_theta, x12, x, theta22)*theta22_xu +...
     d2_parallel_transport_PL_xiutheta2(parq11, x12, x, theta22, x12_theta)*theta22_xu +...
     d2_parallel_transport_PL_theta2(parq11, x12, x, theta22)*theta22_theta*theta22_xu +...
     d_parallel_transport_PL_theta2(parq11, x12, x, theta22)*theta22_xutheta;
end
end
...
dnormal_xu = uu*(sin(theta)/norm(xi + x)) -...
   ...
   cross(xi, x)*(cos(theta)/norm(cross(xi, x))^3)*...
   dot(cross(xi, x), cross(xi, uu));
% second derivative of normal with respect to 'x' along 
% the direction 'uu' and 'theta'
...
function d2_parqi_xxiu = d2_parallel_transport_PL_x2x1(qi, xi, x, theta, uu2, uu1)
% second differential of parallel transport of curve 'qi' multiple 'q' 
% from the tangent space at 'xi'
% to the tangent space at 'x'
% along the p-optimal curve defined by the angle 'theta'
% with respect to 'x' and 'xi'
% along directions 'uu2' and 'uu1' correspondingly
T = size(qi, 2);
% 'alpha', 'phi', 'normal', and 'ee2'
alpha = acos(sin(theta)*sqrt((1+dot(xi, x))/2));
phi = 2*asin(sqrt((1-dot(xi,x))/(1+cos(theta)^2-...
...
v1 = -sin(phi)*cos(phi*cos(alpha))+...
    cos(alpha)*cos(phi)*sin(phi*cos(alpha));
% first derivatives of 'v1', 'v2', and 'v3'
dv3_alpha = phi*sin(alpha)^2*cos(phi*cos(alpha)) -...
    sin(phi*cos(alpha))*cos(alpha);
dv3_phi = -cos(alpha)*sin(alpha)*cos(phi*cos(alpha));
dv2_alpha = -sin(alpha)*(sin(phi*cos(alpha))*sin(phi) -...
...
d2v1_phiphi = -(cos(alpha)^2 - 1)*(sin(phi)*cos(phi*cos(alpha)) +...
    sin(phi*cos(alpha))*cos(alpha)*cos(phi)); 
% finally
d2_parqi_xxiu = zeros(3, T);
for j=1:T
%{ 
 parqi(:, j) = dot(e2, qi(:, j))*v +...
        dot(cross(e2, xi), qi(:, j))*cross(v, x);
 dparqi_xu(:, j) = dot(de2_xu(uu2), qi(:, j))*v +...
        dot(e2, qi(:, j))*dv_xu(uu2) +...
        dot(cross(de2_xu(uu2), xi), qi(:, j))*cross(v, x) +...
        dot(cross(e2, xi), qi(:, j))*cross(dv_xu(uu2), x) +...
        dot(cross(e2, xi), qi(:, j))*cross(v, uu2);
%}
 d2_parqi_xxiu(:, j) = dot(d2_e2_xxiu(uu2, uu1), qi(:, j))*v +...
    dot(de2_xu(uu2), qi(:, j))*dv_xiu(uu1) +...% the second term
    dot(de2_xiu(uu1), qi(:, j))*dv_xu(uu2) +...
    dot(e2, qi(:, j))*d2_v_xxiu(uu2, uu1) +...% the third term
    dot(cross(d2_e2_xxiu(uu2, uu1), xi), qi(:, j))*cross(v, x) +...
    dot(cross(de2_xu(uu2), uu1), qi(:, j))*cross(v, x) +...
    dot(cross(de2_xu(uu2), xi), qi(:, j))*cross(dv_xiu(uu1), x) +...% the fourth term
    dot(cross(de2_xiu(uu1), xi), qi(:, j))*cross(dv_xu(uu2), x) +...
    dot(cross(e2, uu1), qi(:, j))*cross(dv_xu(uu2), x) +...
    dot(cross(e2, xi), qi(:, j))*cross(d2_v_xxiu(uu2, uu1), x) +...% the final term
    dot(cross(de2_xiu(uu1), xi), qi(:, j))*cross(v, uu2) +...
    dot(cross(e2, uu1), qi(:, j))*cross(v, uu2) +...
    dot(cross(e2, xi), qi(:, j))*cross(dv_xiu(uu1), uu2);
end
% with
function mat = d2_v_xxiu(u2, u1)
%{
v = v1*e1 + v2*e2 + v3*normal;
dv_xu = e1*dv1_xu(u2) + e2*dv2_xu(u2) + normal*dv3_xu(u2) +...
      + de1_xu(u2)*v1 + de2_xu(u2)*v2 + dnormal_xu(u2)*v3
%}
 mat = de1_xiu(u1)*dv1_xu(u2) +...
       de2_xiu(u1)*dv2_xu(u2) +...
       dnormal_xiu(u1)*dv3_xu(u2) +...
       e1*d2_v1_xxiu(u2, u1) +...
       e2*d2_v2_xxiu(u2, u1) +...
       normal*d2_v3_xxiu(u2, u1) +...
       d2_e1_xxiu(u2, u1)*v1 +...
       d2_e2_xxiu(u2, u1)*v2 +...
       d2_normal_xxiu(u2, u1)*v3 +...
       de1_xu(u2)*dv1_xu(u1) +...
       de2_xu(u2)*dv2_xu(u1) +...
       dnormal_xu(u2)*dv3_xu(u1);
end
function matu = d2_e1_xxiu(u2, u1)
%{
 e1 = cross(ee2, normal);
 de1_xu = cross(dee2_xu(u2), normal) + cross(ee2, dnormal_xu(u2));
%}
 if (dot(cross(cross(normal, xi), normal), xi) >= 0)
   matu = cross(d2_ee2_xxiu(u2, u1), normal) +...
    cross(dee2_xu(u2), dnormal_xiu(u1)) +...% the second term
    cross(dee2_xiu(u1), dnormal_xu(u2)) +...
    cross(ee2, d2_normal_xxiu(u2, u1));
 else
   matu = -cross(d2_ee2_xxiu(u2, u1), normal) -...
    cross(dee2_xu(u2), dnormal_xiu(u1)) -...% the second term
    cross(dee2_xiu(u1), dnormal_xu(u2)) -...
...
function mat = d2_e2_xxiu(u2, u1)
     if (dot(cross(normal, xi), dbeta0) >= 0)
        mat = d2_ee2_xxiu(u2, u1);
     else
        mat = -d2_ee2_xxiu(u2, u1); 
     end
end
% the hessian of 'ee2' with respect to 'x' and 'xi'
% along directions 'u2' and 'u1' correspondly  
function mat = d2_ee2_xxiu(u2, u1)
%{
 % ee2 = cross(normal, xi)/norm(cross(normal, xi));
 dee2_xu2 = -cross(normal, xi)*...
     dot(cross(normal, xi), cross(dnormal_xu(u2), xi))/...
     norm(cross(normal, xi))^3 +...
     cross(dnormal_xu(u2), xi)/norm(cross(normal, xi)); 
%}
mat = -((cross(dnormal_xiu(u1), xi) + cross(normal, u1))*...
  dot(cross(normal, xi), cross(dnormal_xu(u2), xi))/...
  norm(cross(normal, xi))^3 +...
  cross(normal, xi)*dot(cross(dnormal_xiu(u1), xi) +...
  cross(normal, u1), cross(dnormal_xu(u2), xi))/...
  norm(cross(normal, xi))^3 +...
  cross(normal, xi)*...
  dot(cross(normal, xi), cross(d2_normal_xxiu(u2, u1), xi) +...
  cross(dnormal_xu(u2), u1))/norm(cross(normal, xi))^3 -...
  cross(normal, xi)*...
  dot(cross(normal, xi), cross(dnormal_xu(u2), xi))*...
  3*dot(cross(normal, xi), cross(dnormal_xiu(u1), xi) +...
  cross(normal, u1))/norm(cross(normal, xi))^5) +...% the second term
  ((cross(d2_normal_xxiu(u2, u1), xi) +...
  cross(dnormal_xu(u2), u1))/norm(cross(normal, xi)) -...
  cross(dnormal_xu(u2), xi)*...
  dot(cross(normal, xi), cross(dnormal_xiu(u1), xi) +...
  cross(normal, u1))/norm(cross(normal, xi))^3);
end
% the hessian of 'normal' with respect to 'x' and 'xi'
% along directions 'u2' and 'u1' correspondly  
function mat = d2_normal_xxiu(u2, u1)
%{    
 dnormal_xu2 = u2*(sin(theta)/norm(xi + x)) -...
   (xi + x)*(sin(theta)/norm(xi + x)^3)*dot(xi + x, u2) +...
   cross(xi, u2)*(cos(theta)/norm(cross(xi, x))) -...
   cross(xi, x)*(cos(theta)/norm(cross(xi, x))^3)*...
   dot(cross(xi, x), cross(xi, u2));
%}
mat = -u2*dot(xi + x, u1)*(sin(theta)/norm(xi + x)^3) -...% the second term
  (u1*(sin(theta)/norm(xi + x)^3)*dot(xi + x, u2) -...
  (xi + x)*(sin(theta)/norm(xi + x)^5)*3*...
  dot(xi + x, u1)*dot(xi + x, u2) +...
  (xi + x)*(sin(theta)/norm(xi + x)^3)*dot(u1, u2)) +...% the third term
  (cross(u1, u2)*(cos(theta)/norm(cross(xi, x))) -...
  cross(xi, u2)*(cos(theta)/norm(cross(xi, x))^3)*...
  dot(cross(xi, x), cross(u1, x))) -...% the final term
  (cross(u1, x)*(cos(theta)/norm(cross(xi, x))^3)*...
  dot(cross(xi, x), cross(xi, u2)) -...
  cross(xi, x)*(cos(theta)/norm(cross(xi, x))^5)*...
  3*dot(cross(xi, x), cross(u1, x))*...
  dot(cross(xi, x), cross(xi, u2)) +...
  cross(xi, x)*(cos(theta)/norm(cross(xi, x))^3)*...
  dot(cross(u1, x), cross(xi, u2)) +...
  cross(xi, x)*(cos(theta)/norm(cross(xi, x))^3)*...
  dot(cross(xi, x), cross(u1, u2)));
end
% hessians of 'v1', 'v2', and 'v1'
% with respect to 'x' and 'xi'
% along directions 'u2' and 'u1' correspondingly
function matu = d2_v3_xxiu(u2, u1)
% dv3_xu = dv3_alpha*dalpha_xu(u2) + dv3_phi*dphi_xu(u2);
 matu = dv3_alpha*d2_alpha_xxiu(u2, u1) +...
    d2v3_alphaalpha*dalpha_xiu(u1)*dalpha_xu(u2) +...
    d2v3_alphaphi*(dphi_xiu(u1)*dalpha_xu(u2) +...
    dalpha_xiu(u1)*dphi_xu(u2)) +...
    d2v3_phiphi*dphi_xiu(u1)*dphi_xu(u2) +...
    dv3_phi*d2_phi_xxiu(u2, u1);
end
function matu = d2_v2_xxiu(u2, u1)
% dv2_xu = dv2_alpha*dalpha_xu(u2) + dv2_phi*dphi_xu(u2);
 matu = dv2_alpha*d2_alpha_xxiu(u2, u1) +...
    d2v2_alphaalpha*dalpha_xiu(u1)*dalpha_xu(u2) +...
    d2v2_alphaphi*(dphi_xiu(u1)*dalpha_xu(u2) +...% the second term
    dalpha_xiu(u1)*dphi_xu(u2)) +...
    d2v2_phiphi*dphi_xiu(u1)*dphi_xu(u2) +...
    dv2_phi*d2_phi_xxiu(u2, u1);
end
function matu = d2_v1_xxiu(u2, u1)
% dv1_xu = dv1_alpha*dalpha_xu(u2) + dv1_phi*dphi_xu(u2);
 matu = dv1_alpha*d2_alpha_xxiu(u2, u1) +...
    d2v1_alphaalpha*dalpha_xiu(u1)*dalpha_xu(u2) +...
    d2v1_alphaphi*(dalpha_xu(u2)*dphi_xiu(u1) +...% the second term 
    dphi_xu(u2)*dalpha_xiu(u1)) +...    
    d2v1_phiphi*dphi_xiu(u1)*dphi_xu(u2) +... 
    dv1_phi*d2_phi_xxiu(u2, u1);
end
% Hessian of alpha and phi with respect 'x' and 'xi'
% along directions 'uu2' and 'uu1' respectfully
function matu = d2_alpha_xxiu(u2, u1)
 matu = -sin(theta)*dot(u1, u2)/...
    (4*(Xix/2 + 1/2)^(1/2)*...
    (1 - sin(theta)^2*(Xix/2 + 1/2))^(1/2)) +...
    (-(sin(theta)*(sin(theta)^2*(Xix/2 + 1/2) - 1) +...
    sin(theta)^3*(Xix/2 + 1/2))/(16*(Xix/2 + 1/2)^(3/2)*...
    (1 - sin(theta)^2*(Xix/2 + 1/2))^(3/2)))*...
    dot(xi, u2)*dot(u1, x);
end
function matu = d2_phi_xxiu(u2, u1)
 matu = -(2*sin(theta)^2 - 2)*dot(u1, u2)/...
    ((1 - sin(theta)^2)^(1/2)*...
    (1 - Xix)^(1/2)*(Xix + 1)^(1/2)*...
    (sin(theta)^2 + Xix*sin(theta)^2 - 2)) +...
    (((2*sin(theta)^2 - 2)*(cos(2*theta) + 1)*...
    (3*Xix - cos(2*theta) + 2*Xix^2*cos(2*theta) -...
    2*Xix^2 + Xix*cos(2*theta) + 1))/...
    (4*(1 - sin(theta)^2)^(3/2)*...
    (1 - Xix)^(3/2)*(Xix + 1)^(3/2)*...
...
% differential of 'v' with respect to 'x'
% along the direction 'uu2'
function matu = dv_xu(u2)
% v = v1*e1 + v2*e2 + v3*normal;
 matu = e1*dv1_xu(u2) + e2*dv2_xu(u2) + normal*dv3_xu(u2) +...
      + v1*de1_xu(u2) + v2*de2_xu(u2) + v3*dnormal_xu(u2);
end
% differential of 'v' with respect to 'xi'
% along the direction 'u1'
function matu = dv_xiu(u1)
...
% gradient 'v1', 'v2', and 'v3' with respect to 'x' 
% along the direction 'u2'
function matu = dv3_xu(u2)
 matu = dv3_alpha*dalpha_xu(u2) + dv3_phi*dphi_xu(u2);
end
function matu = dv2_xu(u2)
 matu = dv2_alpha*dalpha_xu(u2) + dv2_phi*dphi_xu(u2);
end
function matu = dv1_xu(u2)
 matu = dv1_alpha*dalpha_xu(u2) + dv1_phi*dphi_xu(u2);
end
% gradient 'v1', 'v2', and 'v3' with respect to 'xi' 
% along the direction 'u1'
function matu = dv3_xiu(u1)
 matu = dv3_alpha*dalpha_xiu(u1) + dv3_phi*dphi_xiu(u1);
end
...
% gradient of 'alpha', and 'phi' with respect to 'x'
% along the direction 'uu2'
function matu = dalpha_xu(u2)
 matu = -sin(theta)*dot(xi, u2)/...
    (4*(Xix/2 + 1/2)^(1/2)*(1 - sin(theta)^2*(Xix/2 + 1/2))^(1/2)); 
end
function matu = dphi_xu(u2)
 matu = -(2*sin(theta)^2 - 2)*dot(xi, u2)/...
    ((1 - sin(theta)^2)^(1/2)*(1 - Xix)^(1/2)*(Xix + 1)^(1/2)*...
    (sin(theta)^2 + Xix*sin(theta)^2 - 2));
end
% gradient of 'alpha', and 'phi' with respect to 'xi'
% along the direction 'uu1'
function matu = dalpha_xiu(u1)
 matu = -sin(theta)*dot(u1, x)/...
    (4*(Xix/2 + 1/2)^(1/2)*(1 - sin(theta)^2*(Xix/2 + 1/2))^(1/2)); 
end
...
%
function matu = de1_xu(u2)
 if (dot(cross(cross(normal, xi), normal), xi) > 0)
  matu = cross(dee2_xu(u2), normal) + cross(ee2, dnormal_xu(u2));
 else
  matu = -cross(dee2_xu(u2), normal) - cross(ee2, dnormal_xu(u2));
 end
end
...
%}
%
function matu = dnormal_xu(u2)
 %{
 normal = (xi + x)*sin(theta)/norm(xi + x)+...
     cross(xi, x)*cos(theta)/norm(cross(xi, x));
   %}
 matu = u2*(sin(theta)/norm(xi + x)) -...
   (xi + x)*(sin(theta)/norm(xi + x)^3)*dot(xi + x, u2) +...% the second term
   cross(xi, u2)*(cos(theta)/norm(cross(xi, x))) -...
   cross(xi, x)*(cos(theta)/norm(cross(xi, x))^3)*...
   dot(cross(xi, x), cross(xi, u2));   
end
