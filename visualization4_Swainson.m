...
%  on the space of unparameterized curves for Swainson data
...
for i=1:N
    Resampled_track = ReSampleSphereTraj(swainson_cord{i+7}, T);
...
% curve
[p1, x1, theta1] = SFrechet(paths0, 30000.6, 50, 10^(-8), 10^(-7), 60, 30, 30);
...
hold off;
%{
% comparison the sample Frechet functions
...
clear swainson_cord swainson_date;
